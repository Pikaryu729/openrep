...
export function widgetTitle(widget: WidgetInstance, exerciseName?: string | null): string {
  const base = WIDGET_CATALOG[widget.type].label
  if (widget.type === 'exercise_progress' && exerciseName) return `${base} · ${exerciseName}`
  return base
}
